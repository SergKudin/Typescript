; (function (window, document, undefined) {
  ...
  (function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); var f = new Error("Cannot find module '" + o + "'"); throw f.code = "MODULE_NOT_FOUND", f } var l = n[o] = { exports: {} }; t[o][0].call(l.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, l, l.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({
    1: [function (require, module, exports) {
      ...
      var _modulesHandleDom = require('./modules/handle-dom.js');

      /*
       * Handy utilities
       */

      var _modulesUtils = require('./modules/utils.js');

      /*
       *  Handle sweetAlert's DOM elements
       */

      var _modulesHandleSwalDom = require('./modules/handle-swal-dom.js');

      // Handle button events and keyboard events

      var _modulesHandleClick = require('./modules/handle-click.js');

      var _modulesHandleKey = require('./modules/handle-key.js');

      var _modulesHandleKey2 = _interopRequireDefault(_modulesHandleKey);

      // Default values

      var _modulesDefaultParams = require('./modules/default-params.js');

      var _modulesDefaultParams2 = _interopRequireDefault(_modulesDefaultParams);

      var _modulesSetParams = require('./modules/set-params.js');
      ...
      var _handleSwalDom = require('./handle-swal-dom.js');

      var _handleDom = require('./handle-dom.js');
      ...
      var _defaultParams = require('./default-params.js');
      ...
      var _injectedHtml = require('./injected-html.js');
